# Benchmark report: tagged-transcript-baseline--held-out--2026-09-07.1

Generated 2026-09-07T08:02:39.078Z.
...
- Corpus: 2026-09-07.1, 12 cases from the held-out split. **Every transcript is synthetic.**
...
| Action recall | 0.24 | 8 of 33 gold actions |
| Action F1 | 0.39 | harmonic mean of the two above |
| Owner accuracy | 0.00 | 0 of 6 matched actions with an explicit gold owner |
| Due-date accuracy | N/A | No matched action has an explicit gold date. |
| Invented owners | 0.00 | 0 of 2 matched actions where the gold owner is unknown |
| Dates resolved where gold is unknown | 0.00 | 0 of 8 matched actions where the gold date is unknown |
| Decision status correctness | 0.07 | 1 of 14 matched decisions |
| Citation coverage | 1.00 | 22 of 22 extracted items cite at least one line |
| Citation validity | 1.00 | 22 of 22 referenced line ids exist |
| Citation support | Pending human review | 22 items await a reviewer's judgment |

## Counts

- Cases attempted: 12
- Cases with no gold actions: 0 (reported separately; recall is N/A for these)
- Decisions missed: 6
...
- Prototype inference cost per accepted case: **No accepted cases** (0 accepted of 12 attempted)
...
- p50 0.03 ms, p95 0.94 ms, observed range 0.02–0.94 ms, n=12
...
36 items are pending. They are listed in review-queue.json.

| Kind | Count |
| --- | --- |
| gold-annotation | 12 |
| citation-support | 11 |
| match-adjudication | 13 |
